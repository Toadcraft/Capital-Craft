...
public class TpoverworldProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (new Object() {
			public int getEnergyStored(LevelAccessor level, BlockPos pos) {
				...
				&& ((entity.level().dimension()) == Level.NETHER || (entity.level().dimension()) == Level.END || (entity.level().dimension()) == ResourceKey.create(Registries.DIMENSION, new ResourceLocation("capital_mode:demonworld")))) {
			{
