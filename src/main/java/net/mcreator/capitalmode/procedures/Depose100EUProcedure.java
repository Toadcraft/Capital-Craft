...
public class Depose100EUProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if ((entity.getCapability(CapitalModeModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CapitalModeModVariables.PlayerVariables())).Argent >= 100) {
			{
				double _setval = (entity.getCapability(CapitalModeModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CapitalModeModVariables.PlayerVariables())).Argent - 100;
			...
			CapitalModeModVariables.MapVariables.get(world).argent_spawn = CapitalModeModVariables.MapVariables.get(world).argent_spawn + 100;
