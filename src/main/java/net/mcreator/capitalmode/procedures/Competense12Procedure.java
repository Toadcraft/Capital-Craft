...
public class Competense12Procedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		if (entity.getData(CapitalModeModVariables.PLAYER_VARIABLES).skills_points >= 2 && entity.getData(CapitalModeModVariables.PLAYER_VARIABLES).skill_12 == 0 && entity.getData(CapitalModeModVariables.PLAYER_VARIABLES).skill_01 >= 1) {
			{
			...
			if (entity.getData(CapitalModeModVariables.PLAYER_VARIABLES).skill_12 == 1) {
				if (entity instanceof Player _player && !_player.level().isClientSide())
