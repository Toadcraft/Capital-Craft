...
import net.mcreator.capitalmode.procedures.WarpnetherProcedure;
import net.mcreator.capitalmode.procedures.TPProcedure;
import net.mcreator.capitalmode.procedures.RtpprocedureProcedure;
...
public record WarpsButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<WarpsButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(CapitalModeMod.MODID, "warps_buttons"));
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 2) {
			...
			RtpprocedureProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		CapitalModeMod.addNetworkMessage(WarpsButtonMessage.TYPE, WarpsButtonMessage.STREAM_CODEC, WarpsButtonMessage::handleData);
	}
}