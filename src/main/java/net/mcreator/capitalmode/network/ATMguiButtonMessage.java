...
public record ATMguiButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<ATMguiButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(CapitalModeMod.MODID, "at_mgui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CapitalModeMod.addNetworkMessage(ATMguiButtonMessage.TYPE, ATMguiButtonMessage.STREAM_CODEC, ATMguiButtonMessage::handleData);
	}
}