...
public class GGguerierScreen extends AbstractContainerScreen<GGguerierMenu> {
	private final static HashMap<String, Object> guistate = GGguerierMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public GGguerierScreen(GGguerierMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("capital_mode:textures/screens/g_gguerier.png");
