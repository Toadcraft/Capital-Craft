...
public class ATMretireScreen extends AbstractContainerScreen<ATMretireMenu> implements CapitalModeModScreens.ScreenAccessor {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("capital_mode:textures/screens/at_mretire.png");
	...
	public void init() {
		...
		button_1eu = Button.builder(Component.translatable("gui.capital_mode.at_mretire.button_1eu"), e -> {
			int x = ATMretireScreen.this.x;
			int y = ATMretireScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new ATMretireButtonMessage(0, x, y, z));
		...
		button_10eu = Button.builder(Component.translatable("gui.capital_mode.at_mretire.button_10eu"), e -> {
			...
			int y = ATMretireScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new ATMretireButtonMessage(1, x, y, z));
		...
		button_100eu = Button.builder(Component.translatable("gui.capital_mode.at_mretire.button_100eu"), e -> {
			...
			int y = ATMretireScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new ATMretireButtonMessage(2, x, y, z));
		...
		button_1000eu = Button.builder(Component.translatable("gui.capital_mode.at_mretire.button_1000eu"), e -> {
			...
			int y = ATMretireScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new ATMretireButtonMessage(3, x, y, z));
		...
		button_retour = Button.builder(Component.translatable("gui.capital_mode.at_mretire.button_retour"), e -> {
			...
			int y = ATMretireScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new ATMretireButtonMessage(4, x, y, z));
