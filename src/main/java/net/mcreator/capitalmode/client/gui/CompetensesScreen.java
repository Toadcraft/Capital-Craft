...
public class CompetensesScreen extends AbstractContainerScreen<CompetensesMenu> implements CapitalModeModScreens.ScreenAccessor {
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	private boolean menuStateUpdateActive = false;
	private Button button_page_2;
	...
	private static final ResourceLocation texture = ResourceLocation.parse("capital_mode:textures/screens/competenses.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, ResourceLocation.parse("capital_mode:textures/screens/qerzft.png"), this.leftPos + 0, this.topPos + 0, 0, 0, 375, 200, 375, 200);
	}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, VariableskillsProcedure.execute(entity), 7, 6, -12829636, false);
	}
	...
	public void init() {
		...
		button_page_2 = Button.builder(Component.translatable("gui.capital_mode.competenses.button_page_2"), e -> {
			int x = CompetensesScreen.this.x;
			int y = CompetensesScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new CompetensesButtonMessage(0, x, y, z));
