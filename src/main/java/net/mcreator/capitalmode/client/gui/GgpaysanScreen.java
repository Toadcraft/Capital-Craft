...
public class GgpaysanScreen extends AbstractContainerScreen<GgpaysanMenu> {
	private final static HashMap<String, Object> guistate = GgpaysanMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public GgpaysanScreen(GgpaysanMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("capital_mode:textures/screens/ggpaysan.png");
