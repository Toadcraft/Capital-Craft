...
public class GardiendemoniaqueRenderer extends HumanoidMobRenderer<GardiendemoniaqueEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private GardiendemoniaqueEntity entity = null;
	...
	@Override
	public void extractRenderState(GardiendemoniaqueEntity entity, HumanoidRenderState state, float partialTicks) {
