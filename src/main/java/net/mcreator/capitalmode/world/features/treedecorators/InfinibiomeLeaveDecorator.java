...
public class InfinibiomeLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<InfinibiomeLeaveDecorator> CODEC = MapCodec.unit(InfinibiomeLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("capital_mode:infinibiome_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}
