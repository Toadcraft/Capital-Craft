...
package net.mcreator.capitalmode.world.features.treedecorators;
...
public class InfinibiomeFruitDecorator extends CocoaDecorator {
	public static Codec<InfinibiomeFruitDecorator> CODEC = Codec.unit(InfinibiomeFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("infinibiome_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public InfinibiomeFruitDecorator() {
		super(0.2f);
	}
