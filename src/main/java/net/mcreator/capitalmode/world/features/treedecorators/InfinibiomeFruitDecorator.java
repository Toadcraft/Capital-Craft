...
public class InfinibiomeFruitDecorator extends CocoaDecorator {
	public static MapCodec<InfinibiomeFruitDecorator> CODEC = MapCodec.unit(InfinibiomeFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("capital_mode:infinibiome_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}
